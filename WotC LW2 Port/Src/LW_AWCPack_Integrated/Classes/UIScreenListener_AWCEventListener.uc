...
function EventListenerReturn UpdateUnitAWCAbilities(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID)
{
	local XComLWTuple OverrideTuple;
...
function EventListenerReturn AddArmoryMainMenuItem(Object EventData, Object EventSource, XComGameState NewGameState, Name InEventID, Object CallbackData)
{
	...
	// -------------------------------------------------------------------------------
	// AWC Abilities: 
	if ((class'LWAWCUtilities'.static.GetAWCComponent(Unit) != none && XCOMHQ.HasFacilityByName('AdvancedWarfareCenter')) || class'UIArmory_AWCExpandedPromotion_LW'.default.ALWAYSSHOW) 
	{
