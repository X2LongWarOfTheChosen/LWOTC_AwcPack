//---------------------------------------------------------------------------------------
//  FILE:    UIScreenListener_ChooseUpgrade_AWCPack_LW.uc
//  AUTHOR:  Amineri (Pavonis Interactive)
//
//  PURPOSE: Fixed display defects in AWC facility upgrade
//--------------------------------------------------------------------------------------- 

class UIScreenListener_ChooseUpgrade_AWCPack_LW extends UIScreenListener;
...
event OnInit(UIScreen Screen)
{
	...
	`Log("LW AWCPack (ChooseUpgrade): Starting OnInit");
	...
	// only update OTS
	if (Facility.GetMyTemplateName() == 'AdvancedTrainingCenter')
	{
		`Log("LW AWCPack (ChooseUpgrade): Adjusting AdvancedTrainingCenter");
