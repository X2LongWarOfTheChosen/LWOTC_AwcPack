//---------------------------------------------------------------------------------------
//  FILE:    UIScreenListener_FacilityUpgrade_AWCPack_LW.uc
//  AUTHOR:  Amineri (Pavonis Interactive)
//
//  PURPOSE: Fixed display defects in AWC facility upgrade
//--------------------------------------------------------------------------------------- 

class UIScreenListener_FacilityUpgrade_AWCPack_LW extends UIScreenListener;
...
event OnInit(UIScreen Screen)
{
	...
	// only update OTS
	if (ParentScreen.GetFacility().GetMyTemplateName() == 'AdvancedWarfareCenter')
	{
